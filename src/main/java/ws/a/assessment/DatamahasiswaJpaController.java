...
import ws.a.assessment.exceptions.NonexistentEntityException;
import ws.a.assessment.exceptions.PreexistingEntityException;
...
public class DatamahasiswaJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ws.a_assessment_jar_0.0.1-SNAPSHOTPU");
